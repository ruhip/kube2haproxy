...
func (s *ProxyServerConfig) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&s.HaproxyConfig.ConfiguePath, "haproxy-configuePath", s.HaproxyConfig.ConfiguePath, "Path of haproxy service files")
	fs.StringVar(&s.HaproxyConfig.PidPath, "haproxy-pidpath", s.HaproxyConfig.PidPath, "Path of haproxy pid files")
	fs.StringVar(&s.HaproxyConfig.ExecFile, "haproxy-execPath", s.HaproxyConfig.ExecFile, "Path of haproxy")
}
